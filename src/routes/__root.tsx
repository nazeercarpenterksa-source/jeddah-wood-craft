...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "نجار الحمدانية جده فك تركيب وصيانه | أفضل نجار في جدة - Best Carpenter in Jeddah" },
      ...
      { property: "og:title", content: "نجار الحمدانية جده فك تركيب وصيانه | أفضل نجار في جدة - Best Carpenter in Jeddah" },
      { property: "og:description", content: "أفضل نجار بجدة لخدمات النجارة المنزلية: فك وتركيب غرف نوم، مطابخ، أبواب، ديكورات. خبرة 15+ سنة وضمان على الأعمال." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "نجار الحمدانية جده فك تركيب وصيانه" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "نجار الحمدانية جده فك تركيب وصيانه | أفضل نجار في جدة - Best Carpenter in Jeddah" },
