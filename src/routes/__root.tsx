...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "نجار الحمدانية جده فك و تركيب اثاث و صيانه" },
      { property: "og:title", content: "نجار الحمدانية جده فك و تركيب اثاث و صيانه | جدة" },
      ...
      { property: "og:site_name", content: "نجار الحمدانية جده فك و تركيب اثاث و صيانه" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "نجار الحمدانية جده فك و تركيب اثاث و صيانه | جدة" },
