...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "نجار الحمدانية جده فك تركيب وصيانه" },
      { property: "og:title", content: "نجار الحمدانية جده فك تركيب وصيانه | جدة" },
      ...
      { name: "twitter:title", content: "نجار الحمدانية جده فك تركيب وصيانه | جدة" },
