...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "نجار جدة | أفضل نجار في جدة - Best Carpenter in Jeddah" },
      ...
      { name: "twitter:title", content: "نجار جدة | أفضل نجار في جدة - Best Carpenter in Jeddah" },
