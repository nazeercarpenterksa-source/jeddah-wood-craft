...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "نجار الحمدانية جده فك و تركيب وصيانه" },
      { property: "og:title", content: "نجار الحمدانية جده فك و تركيب وصيانه | جدة" },
      ...
      { property: "og:site_name", content: "نجار الحمدانية جده فك و تركيب وصيانه" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "نجار الحمدانية جده فك و تركيب وصيانه | جدة" },
